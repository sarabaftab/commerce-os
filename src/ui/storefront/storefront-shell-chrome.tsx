...
import { LanguageSwitcher, useLocale } from "@/shared/i18n";
...
type StorefrontShellChromeProps = {
  tenantSlug: string;
  children: ReactNode;
  /** Server-rendered cart/account header island (passed as children slot). */
  headerActions: ReactNode;
  /** Server-rendered footer meta island. */
  footerMeta: ReactNode;
  /** Server-rendered promotion banner island. */
  promotionBanner: ReactNode;
};

/**
 * Client chrome for localized nav labels + language switcher.
 * Receives server-rendered header/footer/promo slots as props — do not import
 * server data loaders (Prisma, Next data cache helpers, storefront chrome).
 */
